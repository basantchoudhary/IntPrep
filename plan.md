...
| Ops Gate | [ops-gate-architecture.html](agents/ops-gate/ops-gate-architecture.html) | [ops-gate-design.html](agents/ops-gate/ops-gate-design.html) · [checks.sample.yaml](agents/ops-gate/checks.sample.yaml) · [ops-acceptance-checklist.md](agents/ops-gate/ops-acceptance-checklist.md) |
